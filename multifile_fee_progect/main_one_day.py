"""
successful multi-file script for checking publication for previous date
"""
...
path_to_file = create_report_file(check_date)  # 1 create report file or make new sheet in existing

html = select_today_published_images(check_date)  # 2 get html from page of published photos
